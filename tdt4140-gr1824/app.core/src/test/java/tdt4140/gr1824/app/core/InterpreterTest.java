...
//	}
	...
	public void testReceive() throws SQLException {
		interpreter.receive("1,06325.0761,01024.2219"); //Dette er inni glos
		Assert.assertTrue(DatabaseCommunicator.getCurrentStay(1)[0] == DefinedAreas.glos.getName());
		
		interpreter.receive("1,06325.347,01023.712");
		Assert.assertFalse(DatabaseCommunicator.getCurrentStay(1)[0] == DefinedAreas.glos.getName());
