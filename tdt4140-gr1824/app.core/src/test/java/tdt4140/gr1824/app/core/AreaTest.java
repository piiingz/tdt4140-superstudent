...
public class AreaTest {
	...
	private Area pentArea = new Area(this.pentPoint1, this.pentPoint2, this.pentPoint3, this.pentPoint4, this.pentPoint5);
	...
	private Area hexArea = new Area(this.hexPoint1, this.hexPoint2, this.hexPoint3, this.hexPoint4, this.hexPoint5, this.hexPoint6);
