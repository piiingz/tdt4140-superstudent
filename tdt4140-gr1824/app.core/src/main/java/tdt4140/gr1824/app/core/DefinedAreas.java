...
public class DefinedAreas implements Iterable<Area> {
	...
	public static final Area glos = new Area("glos", new Location(63.419954, 10.398281), new Location(63.419954, 10.409288), 
			new Location(63.415452, 10.398281), new Location(63.415452, 10.409288));
	
	public static final Area sitTrening = new Area("sitTrening", new Location(63.421337, 10.403785), new Location(63.421337, 10.405688), 
			new Location(63.420809, 10.403785), new Location(63.420809, 10.405688));
	
	public static final Area samfundet = new Area("samfundet", new Location(63.422726, 10.394794), new Location(63.422726, 10.396044), 
